    ...
    <div className="d-flex flex-1 flex-direction-column">
        ...
        <div className="content-container margin-top-120 margin-bottom-200">
            <div className="content flex-1 flex-direction-column">
                <h3 className="bold">Why choose The Global CIO Office for your OCIO?"</h3>
                ...
                <h3 className="bold margin-top-100">A US phenomena now going global"</h3>
                <h4 className="margin-top-30 text-justify">“The OCIO market is booming – and its influence is reverberating across the asset management industry.” Alicia McElhaney January 31, 2019 (Institutional Investor)</h4>
            </div>
        </div>
    </div>
)
