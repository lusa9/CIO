    ...
    <div className="d-flex flex-1 flex-direction-column">
        ...
        <div className="content-container margin-bottom-200">
            <div className="content flex-1 flex-direction-column">
                ...
                <h2 className="margin-top-100">The Global CIO Office</h2>
                ...
                <h2 className="margin-top-100">Our team of experts are globally recognised for their credibility, strong track record and extensive experience</h2>
                ...
                <h2 className="margin-top-100">Our independent advice and research are a key differentiator that sets us apart from other investment advisory firms</h2>
                ...
                <h2 className="margin-top-100">A broad platform of support of your investment offering</h2>
