    ...
    <div className="d-flex flex-1 flex-direction-column">
        ...
        <div className="content-container margin-bottom-200">
            <div className="content flex-1 flex-direction-column">
                ...
                <Title className="margin-top-120" text="The Global CIO Office"/>
                ...
                <Title className="margin-top-120" text="Our team of experts are globally recognised for their credibility, strong track record and extensive experience"/>
                ...
                <Title className="margin-top-120" text="Our independent advice and research are a key differentiator that sets us apart from other investment advisory firms"/>
                ...
                <Title className="margin-top-120" text="A broad platform of support of your investment offering"/>
