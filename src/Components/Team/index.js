...
const members = [
  {
    image: gary,
    title: "Gary Dugan – CEO & CIO",
    description:
      "Investment professional with 35+ years experience of buy and sell side of the banking businesses. Gary has managed numerous strongly performing investment and advisory teams in large banks in Europe and more recently in Asia and the Middle East. He has built businesses from scratch and successfully restructured businesses. He had had links with Asia and particularly Singapore since 1999 when he managed money for the GIC (Singapore’s Government of Singapore Investment Corporation), Hong Kong Jockey Club and Brunei government. The core of his career was the 11 years at JPMorgan where he was made Managing Director. On the buy side he worked for asset management firms (e.g. JPMorgan) and private banks (Barclays, Merrill Lynch, Coutts, Emirates NBD and NBAD(National Bank of Abu Dhabi). Gary has a reputation for making bold and non-consensus calls on the markets. He made major bear calls on equity markets in 1987, at the top of the tech boom and the financial crisis in August 2007, and a bull call on equity markets on March 17th 2009. Gary has been a high profile contributor to the international media regularly appearing in the printed press and on TV. He often speaks at conferences and provide industry thought leadership on a number of macro and investment topics. In the past, he made a presentation to the European Parliament on the outlook for asset markets after the introduction of the euro. Gary is highly regarded for his team leadership, the rigour and intellect he bring to the investment process, attention to governance and ethics, and his affinity with clients in presentations and meetings. Gary was voted Private Banker of the year 2015 (MENA) from Wealth Briefing."
  },
  {
    image: johan,
